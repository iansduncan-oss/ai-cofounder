...
export function LoginPage() {
  ...
  useEffect(() => {
    fetch(`${baseUrl}/api/auth/google/client-id`)
      .then((res) => {
        if (res.ok) setGoogleEnabled(true);
      })
      .catch(() => {
  ...
  useEffect(() => {
    ...
    if (oauthError) {
      const messages: Record<string, string> = {
        ...
        oauth_token_exchange: "Could not complete Google sign-in",
        oauth_userinfo: "Could not retrieve Google account info",
        ...
        <CardContent>
          ...
          {googleEnabled && (
            <>
              ...
              <a href={`${baseUrl}/api/auth/google`} className="block">
