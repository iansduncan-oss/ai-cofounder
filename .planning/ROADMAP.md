...
- [x] **Phase 17: Close Integration & Flow Gaps** — Dashboard autonomous sessions page, journal typeConfig fix, project switcher wiring, scheduler tier enforcement (completed 2026-03-15)
...
Plans:
- [x] 17-01-PLAN.md — content_pipeline journal type fix + scheduler tier enforcement wiring
- [x] 17-02-PLAN.md — Autonomous sessions dashboard page + project switcher workspace scoping
