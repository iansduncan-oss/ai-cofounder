...
export interface MonitoringJob {
  check: "github_ci" | "github_prs" | "vps_health" | "vps_containers" | "approval_timeout_sweep" | "budget_check" | "dlq_check" | "follow_up_reminders" | "sandbox_orphan_cleanup" | "self_healing_check" | "discord_hourly_digest" | "productivity_nudge" | "productivity_sync" | "codebase_scan" | "custom";
